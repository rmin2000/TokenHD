...
#
# Usage:
#   bash training/train.sh <model_size> <weighted_mode> <epochs> <incorrp> <corrp> <filtering_t> <output_dir> <data_files>
#
# Arguments:
...
#
# Example:
#   bash training/train.sh Qwen3-1.7B portion 1 1.0 0.02 0.5 ckpts/tokenhd-1.7b data/gpt-4o-mini/math_train/ensemble/ensemble_weighted.jsonl
